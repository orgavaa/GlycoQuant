...
const GPU_STAGES = [
  ...
  { at: 75,  pct: 50,  label: "Extracting features",        detail: "Computing WGA proxy, optional marker modules, actin, and morphology features per cell" },
  ...
  { at: 120, pct: 78,  label: "Computing prototype score", detail: "Composite mechanophenotype prototype score over available imaging features" },
...
const CPU_STAGES = [
  ...
  { at: 120, pct: 45,  label: "Extracting features",        detail: "Computing WGA proxy, optional marker modules, actin, and morphology features per cell" },
