...
const GPU_STAGES = [
  ...
  { at: 75,  pct: 50,  label: "Extracting features",        detail: "Computing 26 interpretable features per cell (glycocalyx, YAP, FA, actin, morphology)" },
...
const CPU_STAGES = [
  ...
  { at: 120, pct: 45,  label: "Extracting features",        detail: "Computing glycocalyx, YAP, focal adhesion, actin, and morphology features per cell" },
